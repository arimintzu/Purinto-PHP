        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="membertopdf.php" target="_blank">
                                      ...
                                      while($row = mysqli_fetch_assoc($cek)) {
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                              <a href="deletemember.php?id_member=<?php echo $row['user_id']; ?>">
                                                <button class="btn btn-danger"
                                                onclick="return confirm('\Member ini akan dihapus dari database. Lanjutkan?')">
                                                  DELETE</button>
                                              </a>
                                            </td>
                                        </tr>
