        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="transtopdf.php" target="_blank">
                                      ...
                                      while($row = mysqli_fetch_assoc($cek)) {
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                              <a href="deletetransaksi.php?id_transaksi=<?php echo $row['id']; ?>">
                                                <button class="btn btn-danger"
                                                onclick="return confirm('\Transaksi ini akan dihapus dari database. Lanjutkan?')">
                                                  DELETE</button>
                                              </a>
                                            </td>
                                        </tr>
