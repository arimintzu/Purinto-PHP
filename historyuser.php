...
<body id="top">
  ...
  <section id="login" >
    ...
    letter-spacing:1px">HISTORY TRANSAKSI</h1>
      ...
      margin-bottom: 0px;
      text-transform:uppercase;
      letter-spacing:1px">- <?php echo $row['nama']; ?> -</h1>
        ...
        <?php $no =0;
        $queryTransaksi = "SELECT * FROM transaksi WHERE member_id = '$id' ORDER BY status ASC";
              ...
              <center>
                <table class="table table-bordered table-hover" style="text-align:center; margin-left:11%">
                  ...
                  <?php
                    ...
                    {
                      if($rowTransaksi['deleted_at_by_member']==null) {

                        $no++;
                        $companyID=$rowTransaksi['printing_id'];
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($rowTransaksi['status']==0) {?>
                        <a href="bataltransaksi.php?id_transaksi=<?php echo $rowTransaksi['id']; ?>">
                          <button class="btn btn-info" onclick="return confirm('\Transaksi ini akan dibatalkan. Lanjutkan?')"
                          onmouseover="this.innerHTML='Batal'" onmouseout="this.innerHTML='Di Proses'">Di Proses</button>
                      <?php } else {?>
                        <a href="hapustransaksimember.php?id_transaksi=<?php echo $rowTransaksi['id']; ?>">
