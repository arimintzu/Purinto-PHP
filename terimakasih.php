...
<body id="top" >
  ...
  <section id="sukses" >
    <div class="container">
        <center>
          <img src="img/thanks.png" style="margin-top:50px; margin-bottom:40px; width:60%"/>

          <p id="sukses-desc">TERIMAKASIH<br/>
              SUDAH MENGGUNAKAN JASA KAMI<br/>
              SILAHKAN MENUNGGU, FILE ANDA DALAM PROSES</p>
        </center>
        <br/><br/>
    </div>
  </section>
